...
$(document).on("click",".tui-full-calendar-popup-save",function() { 
    ...
    if(getbrwserType == "Safari"){
     ...
     Sheduler_Save_Edit_Crome_FireFox_Edge();
...
function Sheduler_Save_Edit_Crome_FireFox_Edge(){
                       ...
                       &&(typeof dataSelected_OwnerDropDown !== "undefined" && dataSelected_OwnerDropDown != null) )
                    {
                        ...
                        var user_id_owner = dataSelected_OwnerDropDown._id;
                            ...
                            { 
                                ...
                                //newDate_Start += ":00"; // support to safari //this to start.......16/11/2021
                                //newDate_End += ":00"; // support to safari
                        ...
                        var user_id_owner = dataSelected_OwnerDropDown._id;
                            ...
                            if(typeof Next_Booking_Days_check !== "undefined" && Next_Booking_Days_check != null)
                            {
                                ...
                                var Temp_Date_weekdays = Temp_Date_Winter_dateDiff - Temp_Date_weekenddays;
                                 ...
                                 var currentDates_addOneday =getFormattedDate_WithOut_Zero_Time(adding_MultipleDays(currentDates_addOneday_tmp,1));// currentDates_addOneday_tmp.addDays(1);
                                 var currentDates_addTwoday =getFormattedDate_WithOut_Zero_Time(adding_MultipleDays(currentDates_addTwoay_tmp,2));// currentDates_addOneday_tmp.addDays(1);
                                 ...
                                 if(currentDates == startDateConvertDate)
                                 {
                                    ...
                                    var current_Time = Time_Onley(currentDay_tmp);//current_Time
                                    if("12:00:00" >= current_Time){
            
            
                                        if(3 <= Temp_Date_weekdays){
                
                                            Temp_Date_weekdays = fun_weekDayCount_AddZeroDay(Temp_Date_weekdays);
                                         }
                                         else{
                                            Temp_Date_weekdays = 0;
                                         }
            
                                            Temp_Date_weekenddays = fun_weekendCount_AddZeroDay(Temp_Date_weekenddays)
                                            
                                            Temp_Date_dateDiff = (parseInt(Temp_Date_weekdays) + parseInt(Temp_Date_weekenddays)) - 1;
                                 ...
                                 {      
                                    ...
                                    {                
                                         ...
                                         if(2 <= Temp_Date_weekdays){
                                            ...
                                            Temp_Date_weekdays = fun_weekDayCount_AddOneDay(Temp_Date_weekdays);
                                         }
                                         else{
                                            Temp_Date_weekdays = 0;
                                         }
            
                                            Temp_Date_weekenddays = fun_weekendCount_AddOneDay(Temp_Date_weekenddays)
                                    ...
                                    else if("12:00:00" >= current_Time)
                                    {
                                        if(2 <= Temp_Date_weekdays){
                                            ...
                                            Temp_Date_weekdays = fun_weekDayCount_AddTwoDay(Temp_Date_weekdays);
                                         }
                                         else{
                                            Temp_Date_weekdays = 0;
                                         }
            
                                            Temp_Date_weekenddays = fun_weekendCount_AddTwoDay(Temp_Date_weekenddays)
                                ...
                                // var ssss =  chekInfo_Sheduler_Current;/// =  cheking_Owner_Sheduler_Confirm(obj_Confirm);
                                    ...
                                    //this to start
                                        ...
                                        /*
                                            ...
                                            ////Stand by booking new code...........09-Nov-2021
...
function Sheduler_Save_Edit_Safari(){
    ...
    if(pageIdentiFication == "AdminBooking")
                {
                       ...
                       &&(typeof dataSelected_OwnerDropDown !== "undefined" && dataSelected_OwnerDropDown != null) )
                    {
                        ...
                        var user_id_owner = dataSelected_OwnerDropDown._id;
                            ...
                            var startdate_date = new Date(Safari_suport_Date_format(newDate_Start));
                            var enddate_date = new Date(Safari_suport_Date_format(newDate_End));
                            var start_str =startdate_date.toString();
                            var end_str = calculationOFTwoDateDifferenceINHour(startdate_date,enddate_date);//enddate_date.toString();    
                            var AdminId_get = sessionStorage.getItem("UserId");
                            ...
                            if(typeof Next_Booking_Days_check !== "undefined" && Next_Booking_Days_check != null)
                            {
                                ...
                                var Temp_Date_weekdays = Temp_Date_Winter_dateDiff - Temp_Date_weekenddays;
                                 ...
                                 //let dats_standBy = standByCalculation_booking(start_str);
