...
@Component({
  selector: 'app-archived--all-owners',
  templateUrl: './archived-all-owners.component.html',
  styleUrls: ['./archived-all-owners.component.css']
})
export class archivedAllOwnersComponent implements OnInit {
