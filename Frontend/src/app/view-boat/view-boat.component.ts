...
sessionStorage.setItem("Adminbooking-relodePg","1");
 ...
 function ReloadPages(){
	...
	else if(this.data.Boat_Status == "2")
	{
		...
		this.boatStatus = "Archive";
			...
			this.preDates = moment(this.data.PreLaunch_Date).tz(this.timeszon_Set).format("DD-MM-YYYY");
			 ...
			 this.Summer_From = moment(this.data.SummerSeason_SDate).tz(this.timeszon_Set).format("DD-MM-YYYY");
			...
			this.Summer_To = moment(this.data.SummerSeason_EDate).tz(this.timeszon_Set).format("DD-MM-YYYY");
			...
			this.Winter_From = moment(this.data.WinterSeason_SDate).tz(this.timeszon_Set).format("DD-MM-YYYY");
			...
			this.Winter_To = moment(this.data.WinterSeason_EDate).tz(this.timeszon_Set).format("DD-MM-YYYY");
  ...
  getmaindetails_HandBook_Binding(){
			console.log("dfgtr"+JSON.stringify(this.data));
			 if(this.data.Boat_originalhandBook && this.data.Boat_originalhandBook !='' ){
		 				 this.HandBookUrl = this.imgUrl + this.data.Boat_originalhandBook;
			}
			else{
				this.HandBookUrl = null;
				}
				if(this.data.Boat_original_Owner_Manual && this.data.Boat_original_Owner_Manual !='' ){
					this.ManualBookUrl = this.imgUrl + this.data.Boat_original_Owner_Manual;
	  }
	  else{
		  this.ManualBookUrl = null;
		  }
