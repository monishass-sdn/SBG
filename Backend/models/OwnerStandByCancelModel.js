...
const OwnerStandByCancelSchema = mongoose.Schema({
    Boat_Id:
   {
 ...
 Boat_Name:
 {
  ...
  default:null
   ...
   start:
    ...
    isThisAOwnerCanceledStandByBooking:{
        type:Boolean,
        default:true
    }
})

module.exports = mongoose.model('OwnerStandByCancel', OwnerStandByCancelSchema);